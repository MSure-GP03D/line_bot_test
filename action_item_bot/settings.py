"""
Django settings for action_item_bot project.
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # 追加（django-cors-headers使用時）
    'main',
]
...
ROOT_URLCONF = "action_item_bot.urls"
...
WSGI_APPLICATION = "action_item_bot.wsgi.application"
...
# Firebase設定
FIREBASE_CREDENTIALS = f"{key_file}"  # 既存のファイルパス
